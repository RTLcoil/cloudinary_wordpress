# Contributing to Cloudinary's WordPress Plugin

Contributions are welcome and greatly appreciated!

## Reporting a bug

- Make sure that the bug was not already reported by searching in GitHub under [Issues](https://github.com/cloudinary/cloudinary_wordpress) and the Cloudinary [Support forms](https://support.cloudinary.com).
- If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/cloudinary/cloudinary_wordpress/issues/new).
...
- If you require assistance in the implementation of cloudinary_wordpress please [submit a request](https://support.cloudinary.com/hc/en-us/requests/new) on Cloudinary's site.
...
- Open a GitHub [issue](https://github.com/cloudinary/cloudinary_wordpress) describing the benefits (and possible drawbacks) of the requested feature
...
Fork [project on Github](https://github.com/cloudinary/cloudinary_wordpress) and check your copy.

```
git clone https://github.com/cloudinary/cloudinary_wordpress.git
cd cloudinary_wordpress
git remote add upstream https://github.com/cloudinary/cloudinary_wordpress.git
```
...
Go to https://github.com/cloudinary/cloudinary_wordpress and select your feature branch. Click the 'Pull Request' button and fill out the form. Pull requests are normally reviewed within a few days.
